...
static const unsigned char TIXML_UTF_LEADstd::placeholders::_1 = 0xbbU;
...
const char* XMLUtil::ReadBOM( const char* p, bool* bom )
{
    *bom = false;
    ...
    if (    *(pu+0) == TIXML_UTF_LEAD_0
            && *(pu+1) == TIXML_UTF_LEADstd::placeholders::_1
...
{
    static const unsigned char bom[] = { TIXML_UTF_LEAD_0, TIXML_UTF_LEADstd::placeholders::_1, TIXML_UTF_LEAD_2, 0 };
    if ( writeBOM ) {
        Print( "%s", bom );
    }
    if ( writeDec ) {
